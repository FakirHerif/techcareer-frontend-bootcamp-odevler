...
let fiyat = products.filter(ali => ali.unitPrice > 30 && ali.unitPrice < 100)
...
let isim = products.filter(ali => ali.name.startsWith("A"))
...
let isim2 = products.filter(ali => ali.name.endsWith("a"))
...
let idNumber = products.find(ali => ali.id === 10)
...
let falseDeger = products.filter(ali => ali.discontinued === false)

console.log(falseDeger);

console.log("---------- 5. ÖDEV SONU ----------")

// 6

let enYuksek = products.reduce((enYuksek, urun) => {
    if (urun.unitPrice > enYuksek.unitPrice) {
        return urun;
    } else {
        return enYuksek;
    }
...
console.log(enYuksek);

console.log("---------- 6. ÖDEV SONU ----------")

// 7

let enKucuk = products.reduce((enKucuk, urun) => {
    if (urun.unitPrice < enKucuk.unitPrice) {
        return urun;
    } else {
        return enKucuk;
    }
